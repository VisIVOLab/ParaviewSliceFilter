...
void vtkPVSliceFilter::SimpleExecute(vtkImageData *in, vtkImageData *out)
{
    ...
    std::cerr << "Taking a cube of dimensions [" << inDims[0] << ", " << inDims[1] << ", " << inDims[2] << "] and start and end points (" << StartPoint.first << ", " << StartPoint.second << ") and (" << EndPoint.first << ", " << EndPoint.second << ") as input." << std::endl;
